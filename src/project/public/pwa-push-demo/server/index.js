...
// ДЕБАГ: Проверяем загрузились ли ключи
console.log('Загружен Public Key:', process.env.VAPID_PUBLIC_KEY);
console.log('Длина ключа:', process.env.VAPID_PUBLIC_KEY?.length);
...
console.log('✅ VAPID инициализированы успешно!');
// Хранилище подписок
let subscriptions = [];
